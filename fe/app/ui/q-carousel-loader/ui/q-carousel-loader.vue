...
import { useSize, type ColorProps, type SizeProps } from "~/utils/ui-toolkit";
...
const colorCssVars = computed<{ "--fill-color": string; "--stroke-color": string }>(() => {
  const cssVars = (() => {
    switch ($props.color) {
      case "secondary":
        return { "--fill-color": "--md-sys-color-secondary-container", "--stroke-color": "--md-sys-color-secondary" };
      case "tertiary":
        return { "--fill-color": "--md-sys-color-tertiary-container", "--stroke-color": "--md-sys-color-tertiary" };
      case "error":
        return { "--fill-color": "--md-sys-color-error-container", "--stroke-color": "--md-sys-color-error" };
      default:
        return { "--fill-color": "--md-sys-color-primary-container", "--stroke-color": "--md-sys-color-primary" };
    }
  })();

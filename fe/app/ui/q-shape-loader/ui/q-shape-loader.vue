...
import { useDimension, useUiContext, type ColorProps, type DimensionProps, type LoadingProps, type SizeProps } from "~/utils/ui-toolkit";
...
.shape-loader__mask {
  ...
  z-index: 0;
  inset: 0;
  background-color: color-mix(in srgb, var(--md-sys-color-scrim) 20%, transparent);
}
